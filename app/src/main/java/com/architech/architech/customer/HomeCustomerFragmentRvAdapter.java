...
public class HomeCustomerFragmentRvAdapter extends RecyclerView.Adapter<HomeCustomerFragmentRvAdapter.MyViewHolder> {
    ArrayList <FloorPlan> listOfFloorPlans;
    Context context;

    public HomeCustomerFragmentRvAdapter(ArrayList<FloorPlan> listOfFloorPlans, Context context)
    {
